...
@pcc_set
class FkfungNssabaLink(Link):
    USERAGENTSTRING = "FkfungNssaba"
...
@subset(FkfungNssabaLink)
class FkfungNssabaUnprocessedLink(object):
    @staticmethod
    def __predicate__(l):
...
@impure
@subset(FkfungNssabaUnprocessedLink)
class OneFkfungNssabaUnProcessedLink(FkfungNssabaLink):
    __limit__ = 1
    @staticmethod
    def __predicate__(l):
        return not (l.download_complete or l.error_reason)

@projection(FkfungNssabaLink, FkfungNssabaLink.url, FkfungNssabaLink.download_complete)
class FkfungNssabaProjectionLink(object):
    pass

@trigger(OneFkfungNssabaUnProcessedLink, TriggerTime.after, TriggerAction.read)
...
@trigger(FkfungNssabaLink, TriggerTime.after, TriggerAction.update)
