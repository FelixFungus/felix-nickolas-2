...
from datamodel.search.FkfungNssaba_datamodel import FkfungNssabaProjectionLink
...
@Deleter(FkfungNssabaProjectionLink)
@Getter(FkfungNssabaProjectionLink)
class DeleteFrontierFrame(IApplication):
    ...
    def update(self):
        ...
        ls = self.frame.get(FkfungNssabaProjectionLink)
        print "Found ", len(ls), " links to delete."
        for l in ls:
            self.frame.delete(FkfungNssabaProjectionLink, l)
